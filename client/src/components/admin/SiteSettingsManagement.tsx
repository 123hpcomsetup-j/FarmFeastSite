...
export default function SiteSettingsManagement() {
  ...
  const predefinedSettings = [
    ...
    { key: "google_maps_place_url", placeholder: "https://www.google.com/maps/place/Farm+Feast+FarmHouse/...", icon: MapPin },
    { key: "google_maps_embed_url", placeholder: "https://www.google.com/maps/embed?pb=...", icon: MapPin },
    { key: "google_maps_directions_url", placeholder: "https://www.google.com/maps/dir//Farm+Feast+FarmHouse/...", icon: MapPin },
    { key: "location_latitude", placeholder: "28.7041", icon: MapPin },
    { key: "location_longitude", placeholder: "77.1025", icon: MapPin },
